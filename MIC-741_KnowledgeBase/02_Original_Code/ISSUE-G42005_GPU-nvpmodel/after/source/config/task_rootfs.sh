...
# TODO: Fix fio feature
# mkdir -p $project/source/modify/driver/rootfs/etc/apt/preferences.d/
# echo -e '\nPackage: nvidia-l4t-*\nPin: version 38.2.1-20250910123945\nPin-Priority: 999' | tee $project/source/modify/driver/rootfs/etc/apt/preferences.d/nvidia-repo-pin
