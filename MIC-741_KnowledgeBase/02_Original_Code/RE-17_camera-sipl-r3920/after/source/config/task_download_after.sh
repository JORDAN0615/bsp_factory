...
# ==========================================
TARGET_L4T_VERSION="39.2.0"
# ==========================================

case "$TARGET_L4T_VERSION" in
    "39.2.0")
        URL_SIPL="https://developer.nvidia.com/downloads/embedded/L4T/r39_Release_v2.0/release/Jetson_SIPL_API_R39.2.0_aarch64.tbz2"
        MD5_SIPL="3e9b8a80e91e9ff3504207beb48582b1"
        ;;
    "38.4.0")
